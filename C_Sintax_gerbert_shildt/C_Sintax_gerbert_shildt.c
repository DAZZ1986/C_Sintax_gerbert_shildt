...
int main(void)
{
    ...
    */
    ...
    А локальные переменные (исключая статические локальные) инициализируются каждый раз при входе в блок, в котором они 
    объявлены. 
    Неинициализированные локальные переменные до первого присвоения имеют произвольное значение. 
    Неинициализированные глобальные и статические локальные переменные в начале работы программы автоматически обнуляются.
   */


    /*
    Виды переменные:
    локальные - объявленная в блоке{}(функции, if конструкции итд), видимость в рамках блока.
    глобальные - объявленная вне блоков{}, видимость в рамках программы во всех файлах.
    локальные статические - объявленная в блоке{}, видимость в рамках блока.
    глобальные статические - объявленная вне блоков{}, видимость в рамках файла.
