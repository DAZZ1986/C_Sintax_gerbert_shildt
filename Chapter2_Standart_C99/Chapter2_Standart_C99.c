...
int main(void)
{
	...
	*/
	...
	Содержание:
		...
		Новые возможности семейства функций printf() и scanf_s()	//ДО ЭТОГО МОМЕНТА ПОВТОРИТЬ ЭТИ ПУНКТЫ В Глава 08. Ввод / вывод на консоль
	...
	*/
	...
	К другим важным новинкам относятся:
		...
		массивы с переменными границами в качестве членов структур
		назначенные инициализаторы
		изменения в семействе функций printf() и scanf_s()
		зарезервированный идентификатор __func__
	...
	*/
	...
	void *memcpy(void * restrict cmp1, const void * restrict cmp2, size_t размер);	//ЖЕНЯ
	...
	*/
	...
	///////////Использование квалификаторов типов в объявлении массива	//ЖЕНЯ
	...
	*/
	...
	struct mystruct *p;
	p = (struct mystruct *) malloc(sizof(struct mystuct) + 10 *sizof(float);)
	...
	*/
	...
	printf("\n\n\n/////////// Новые возможности семейства функций printf() и scanf_s()\n");
	/*
	В С99 для семейства функций printf() и scanf_s() предусмотрена новая возможность: они могут манипулировать с типами данных
	...
	Модификатор ll можно применять к спецификаторам формата: d, i, о, u и x — как для printf(), так и для scanf_s().
	...
	scanf_s() и они читают значение с плавающей точкой.
